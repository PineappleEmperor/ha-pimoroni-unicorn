...
_PHL_HUB = "9C139EFFFED43FC8"

cat_sensors = [
    {
        "id": "lola", "name": "Lola",
        "topic": f"PetHubLocal/ha/pet/747A075A42EE01/hub/{_PHL_HUB}",
        "location_key": "5410ECFFFE9C2A10",
        "on_rgb": (140, 192,  80), "off_rgb": ( 35,  48, 20), "state": False,
    },
    {
        "id": "merlin", "name": "Merlin",
        "topic": f"PetHubLocal/ha/pet/9244CA0480EF01/hub/{_PHL_HUB}",
        "location_key": "5410ECFFFE9C2A10",
        "on_rgb": (247, 190,  18), "off_rgb": ( 62,  48,  5), "state": False,
    },
    {
        "id": "yeren", "name": "Yeren",
        "topic": f"PetHubLocal/ha/pet/19C6CA0480EF01/hub/{_PHL_HUB}",
        "location_key": "5410ECFFFE9C2A10",
