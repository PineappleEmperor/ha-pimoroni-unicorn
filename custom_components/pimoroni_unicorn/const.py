...
# Text faces the engine can draw notifications in; must match _TEXT_FACES in
# firmware/engine/notify_animations.py. "heavy" is the purpose-drawn bold cut.
NOTIFY_FONTS = ["bitmap8", "heavy", "font5x9", "font3x5"]
