        ...
        <div class="col">
          <div class="stagewrap" @wheel=${this.onWheel} @pointerdown=${this.startPan}>
            <div class="stage" style=${`width:${this.dims[0]*t}px;height:${this.dims[1]*t}px`}>
              ...
              ${this.locked?"":l`<div class="boxes ${this.wireframe?"wf":""}">${this.layout.widgets.map((n,c)=>{if(!this.capForEntry(n)||n.enabled===!1)return"";let[u,m]=this.boxDims(c);return l`<div class="box ${c===this.selected?"sel":""}"
