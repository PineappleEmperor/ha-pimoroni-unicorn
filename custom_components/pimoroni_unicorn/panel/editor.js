var Lt=Object.defineProperty;var Ct=Object.getOwnPropertyDescriptor;var p=(o,i,t,e)=>{for(var s=e>1?void 0:e?Ct(i,t):i,a=o.length-1,n;a>=0;a--)(n=o[a])&&(s=(e?n(i,t,s):n(s))||s);return e&&s&&Lt(i,t,s),s};var D=globalThis,W=D.ShadowRoot&&(D.ShadyCSS===void 0||D.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,V=Symbol(),nt=new WeakMap,T=class{constructor(i,t,e){if(this._$cssResult$=!0,e!==V)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=i,this.t=t}get styleSheet(){let i=this.o,t=this.t;if(W&&i===void 0){let e=t!==void 0&&t.length===1;e&&(i=nt.get(t)),i===void 0&&((this.o=i=new CSSStyleSheet).replaceSync(this.cssText),e&&nt.set(t,i))}return i}toString(){return this.cssText}},ot=o=>new T(typeof o=="string"?o:o+"",void 0,V),B=(o,...i)=>{let t=o.length===1?o[0]:i.reduce((e,s,a)=>e+(n=>{if(n._$cssResult$===!0)return n.cssText;if(typeof n=="number")return n;throw Error("Value passed to 'css' function must be a 'css' function result: "+n+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(s)+o[a+1],o[0]);return new T(t,o,V)},lt=(o,i)=>{if(W)o.adoptedStyleSheets=i.map(t=>t instanceof CSSStyleSheet?t:t.styleSheet);else for(let t of i){let e=document.createElement("style"),s=D.litNonce;s!==void 0&&e.setAttribute("nonce",s),e.textContent=t.cssText,o.appendChild(e)}},U=W?o=>o:o=>o instanceof CSSStyleSheet?(i=>{let t="";for(let e of i.cssRules)t+=e.cssText;return ot(t)})(o):o;var{is:It,defineProperty:Ot,getOwnPropertyDescriptor:Nt,getOwnPropertyNames:Rt,getOwnPropertySymbols:Ht,getPrototypeOf:Dt}=Object,z=globalThis,ct=z.trustedTypes,Wt=ct?ct.emptyScript:"",zt=z.reactiveElementPolyfillSupport,L=(o,i)=>o,C={toAttribute(o,i){switch(i){case Boolean:o=o?Wt:null;break;case Object:case Array:o=o==null?o:JSON.stringify(o)}return o},fromAttribute(o,i){let t=o;switch(i){case Boolean:t=o!==null;break;case Number:t=o===null?null:Number(o);break;case Object:case Array:try{t=JSON.parse(o)}catch{t=null}}return t}},P=(o,i)=>!It(o,i),dt={attribute:!0,type:String,converter:C,reflect:!1,useDefault:!1,hasChanged:P};Symbol.metadata??=Symbol("metadata"),z.litPropertyMetadata??=new WeakMap;var $=class extends HTMLElement{static addInitializer(i){this._$Ei(),(this.l??=[]).push(i)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(i,t=dt){if(t.state&&(t.attribute=!1),this._$Ei(),this.prototype.hasOwnProperty(i)&&((t=Object.create(t)).wrapped=!0),this.elementProperties.set(i,t),!t.noAccessor){let e=Symbol(),s=this.getPropertyDescriptor(i,e,t);s!==void 0&&Ot(this.prototype,i,s)}}static getPropertyDescriptor(i,t,e){let{get:s,set:a}=Nt(this.prototype,i)??{get(){return this[t]},set(n){this[t]=n}};return{get:s,set(n){let r=s?.call(this);a?.call(this,n),this.requestUpdate(i,r,e)},configurable:!0,enumerable:!0}}static getPropertyOptions(i){return this.elementProperties.get(i)??dt}static _$Ei(){if(this.hasOwnProperty(L("elementProperties")))return;let i=Dt(this);i.finalize(),i.l!==void 0&&(this.l=[...i.l]),this.elementProperties=new Map(i.elementProperties)}static finalize(){if(this.hasOwnProperty(L("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(L("properties"))){let t=this.properties,e=[...Rt(t),...Ht(t)];for(let s of e)this.createProperty(s,t[s])}let i=this[Symbol.metadata];if(i!==null){let t=litPropertyMetadata.get(i);if(t!==void 0)for(let[e,s]of t)this.elementProperties.set(e,s)}this._$Eh=new Map;for(let[t,e]of this.elementProperties){let s=this._$Eu(t,e);s!==void 0&&this._$Eh.set(s,t)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(i){let t=[];if(Array.isArray(i)){let e=new Set(i.flat(1/0).reverse());for(let s of e)t.unshift(U(s))}else i!==void 0&&t.push(U(i));return t}static _$Eu(i,t){let e=t.attribute;return e===!1?void 0:typeof e=="string"?e:typeof i=="string"?i.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){this._$ES=new Promise(i=>this.enableUpdating=i),this._$AL=new Map,this._$E_(),this.requestUpdate(),this.constructor.l?.forEach(i=>i(this))}addController(i){(this._$EO??=new Set).add(i),this.renderRoot!==void 0&&this.isConnected&&i.hostConnected?.()}removeController(i){this._$EO?.delete(i)}_$E_(){let i=new Map,t=this.constructor.elementProperties;for(let e of t.keys())this.hasOwnProperty(e)&&(i.set(e,this[e]),delete this[e]);i.size>0&&(this._$Ep=i)}createRenderRoot(){let i=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return lt(i,this.constructor.elementStyles),i}connectedCallback(){this.renderRoot??=this.createRenderRoot(),this.enableUpdating(!0),this._$EO?.forEach(i=>i.hostConnected?.())}enableUpdating(i){}disconnectedCallback(){this._$EO?.forEach(i=>i.hostDisconnected?.())}attributeChangedCallback(i,t,e){this._$AK(i,e)}_$ET(i,t){let e=this.constructor.elementProperties.get(i),s=this.constructor._$Eu(i,e);if(s!==void 0&&e.reflect===!0){let a=(e.converter?.toAttribute!==void 0?e.converter:C).toAttribute(t,e.type);this._$Em=i,a==null?this.removeAttribute(s):this.setAttribute(s,a),this._$Em=null}}_$AK(i,t){let e=this.constructor,s=e._$Eh.get(i);if(s!==void 0&&this._$Em!==s){let a=e.getPropertyOptions(s),n=typeof a.converter=="function"?{fromAttribute:a.converter}:a.converter?.fromAttribute!==void 0?a.converter:C;this._$Em=s;let r=n.fromAttribute(t,a.type);this[s]=r??this._$Ej?.get(s)??r,this._$Em=null}}requestUpdate(i,t,e,s=!1,a){if(i!==void 0){let n=this.constructor;if(s===!1&&(a=this[i]),e??=n.getPropertyOptions(i),!((e.hasChanged??P)(a,t)||e.useDefault&&e.reflect&&a===this._$Ej?.get(i)&&!this.hasAttribute(n._$Eu(i,e))))return;this.C(i,t,e)}this.isUpdatePending===!1&&(this._$ES=this._$EP())}C(i,t,{useDefault:e,reflect:s,wrapped:a},n){e&&!(this._$Ej??=new Map).has(i)&&(this._$Ej.set(i,n??t??this[i]),a!==!0||n!==void 0)||(this._$AL.has(i)||(this.hasUpdated||e||(t=void 0),this._$AL.set(i,t)),s===!0&&this._$Em!==i&&(this._$Eq??=new Set).add(i))}async _$EP(){this.isUpdatePending=!0;try{await this._$ES}catch(t){Promise.reject(t)}let i=this.scheduleUpdate();return i!=null&&await i,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??=this.createRenderRoot(),this._$Ep){for(let[s,a]of this._$Ep)this[s]=a;this._$Ep=void 0}let e=this.constructor.elementProperties;if(e.size>0)for(let[s,a]of e){let{wrapped:n}=a,r=this[s];n!==!0||this._$AL.has(s)||r===void 0||this.C(s,void 0,a,r)}}let i=!1,t=this._$AL;try{i=this.shouldUpdate(t),i?(this.willUpdate(t),this._$EO?.forEach(e=>e.hostUpdate?.()),this.update(t)):this._$EM()}catch(e){throw i=!1,this._$EM(),e}i&&this._$AE(t)}willUpdate(i){}_$AE(i){this._$EO?.forEach(t=>t.hostUpdated?.()),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(i)),this.updated(i)}_$EM(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(i){return!0}update(i){this._$Eq&&=this._$Eq.forEach(t=>this._$ET(t,this[t])),this._$EM()}updated(i){}firstUpdated(i){}};$.elementStyles=[],$.shadowRootOptions={mode:"open"},$[L("elementProperties")]=new Map,$[L("finalized")]=new Map,zt?.({ReactiveElement:$}),(z.reactiveElementVersions??=[]).push("2.1.2");var Q=globalThis,pt=o=>o,j=Q.trustedTypes,ht=j?j.createPolicy("lit-html",{createHTML:o=>o}):void 0,bt="$lit$",f=`lit$${Math.random().toFixed(9).slice(2)}$`,$t="?"+f,Pt=`<${$t}>`,E=document,O=()=>E.createComment(""),N=o=>o===null||typeof o!="object"&&typeof o!="function",tt=Array.isArray,jt=o=>tt(o)||typeof o?.[Symbol.iterator]=="function",J=`[ 	
\f\r]`,I=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,ut=/-->/g,gt=/>/g,_=RegExp(`>|${J}(?:([^\\s"'>=/]+)(${J}*=${J}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),mt=/'/g,vt=/"/g,ft=/^(?:script|style|textarea|title)$/i,et=o=>(i,...t)=>({_$litType$:o,strings:i,values:t}),l=et(1),te=et(2),ee=et(3),A=Symbol.for("lit-noChange"),v=Symbol.for("lit-nothing"),yt=new WeakMap,S=E.createTreeWalker(E,129);function xt(o,i){if(!tt(o)||!o.hasOwnProperty("raw"))throw Error("invalid template strings array");return ht!==void 0?ht.createHTML(i):i}var Ft=(o,i)=>{let t=o.length-1,e=[],s,a=i===2?"<svg>":i===3?"<math>":"",n=I;for(let r=0;r<t;r++){let c=o[r],u,m,g=-1,y=0;for(;y<c.length&&(n.lastIndex=y,m=n.exec(c),m!==null);)y=n.lastIndex,n===I?m[1]==="!--"?n=ut:m[1]!==void 0?n=gt:m[2]!==void 0?(ft.test(m[2])&&(s=RegExp("</"+m[2],"g")),n=_):m[3]!==void 0&&(n=_):n===_?m[0]===">"?(n=s??I,g=-1):m[1]===void 0?g=-2:(g=n.lastIndex-m[2].length,u=m[1],n=m[3]===void 0?_:m[3]==='"'?vt:mt):n===vt||n===mt?n=_:n===ut||n===gt?n=I:(n=_,s=void 0);let b=n===_&&o[r+1].startsWith("/>")?" ":"";a+=n===I?c+Pt:g>=0?(e.push(u),c.slice(0,g)+bt+c.slice(g)+f+b):c+f+(g===-2?r:b)}return[xt(o,a+(o[t]||"<?>")+(i===2?"</svg>":i===3?"</math>":"")),e]},R=class o{constructor({strings:i,_$litType$:t},e){let s;this.parts=[];let a=0,n=0,r=i.length-1,c=this.parts,[u,m]=Ft(i,t);if(this.el=o.createElement(u,e),S.currentNode=this.el.content,t===2||t===3){let g=this.el.content.firstChild;g.replaceWith(...g.childNodes)}for(;(s=S.nextNode())!==null&&c.length<r;){if(s.nodeType===1){if(s.hasAttributes())for(let g of s.getAttributeNames())if(g.endsWith(bt)){let y=m[n++],b=s.getAttribute(g).split(f),w=/([.?@])?(.*)/.exec(y);c.push({type:1,index:a,name:w[2],strings:b,ctor:w[1]==="."?Y:w[1]==="?"?X:w[1]==="@"?Z:M}),s.removeAttribute(g)}else g.startsWith(f)&&(c.push({type:6,index:a}),s.removeAttribute(g));if(ft.test(s.tagName)){let g=s.textContent.split(f),y=g.length-1;if(y>0){s.textContent=j?j.emptyScript:"";for(let b=0;b<y;b++)s.append(g[b],O()),S.nextNode(),c.push({type:2,index:++a});s.append(g[y],O())}}}else if(s.nodeType===8)if(s.data===$t)c.push({type:2,index:a});else{let g=-1;for(;(g=s.data.indexOf(f,g+1))!==-1;)c.push({type:7,index:a}),g+=f.length-1}a++}}static createElement(i,t){let e=E.createElement("template");return e.innerHTML=i,e}};function k(o,i,t=o,e){if(i===A)return i;let s=e!==void 0?t._$Co?.[e]:t._$Cl,a=N(i)?void 0:i._$litDirective$;return s?.constructor!==a&&(s?._$AO?.(!1),a===void 0?s=void 0:(s=new a(o),s._$AT(o,t,e)),e!==void 0?(t._$Co??=[])[e]=s:t._$Cl=s),s!==void 0&&(i=k(o,s._$AS(o,i.values),s,e)),i}var K=class{constructor(i,t){this._$AV=[],this._$AN=void 0,this._$AD=i,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(i){let{el:{content:t},parts:e}=this._$AD,s=(i?.creationScope??E).importNode(t,!0);S.currentNode=s;let a=S.nextNode(),n=0,r=0,c=e[0];for(;c!==void 0;){if(n===c.index){let u;c.type===2?u=new H(a,a.nextSibling,this,i):c.type===1?u=new c.ctor(a,c.name,c.strings,this,i):c.type===6&&(u=new G(a,this,i)),this._$AV.push(u),c=e[++r]}n!==c?.index&&(a=S.nextNode(),n++)}return S.currentNode=E,s}p(i){let t=0;for(let e of this._$AV)e!==void 0&&(e.strings!==void 0?(e._$AI(i,e,t),t+=e.strings.length-2):e._$AI(i[t])),t++}},H=class o{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(i,t,e,s){this.type=2,this._$AH=v,this._$AN=void 0,this._$AA=i,this._$AB=t,this._$AM=e,this.options=s,this._$Cv=s?.isConnected??!0}get parentNode(){let i=this._$AA.parentNode,t=this._$AM;return t!==void 0&&i?.nodeType===11&&(i=t.parentNode),i}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(i,t=this){i=k(this,i,t),N(i)?i===v||i==null||i===""?(this._$AH!==v&&this._$AR(),this._$AH=v):i!==this._$AH&&i!==A&&this._(i):i._$litType$!==void 0?this.$(i):i.nodeType!==void 0?this.T(i):jt(i)?this.k(i):this._(i)}O(i){return this._$AA.parentNode.insertBefore(i,this._$AB)}T(i){this._$AH!==i&&(this._$AR(),this._$AH=this.O(i))}_(i){this._$AH!==v&&N(this._$AH)?this._$AA.nextSibling.data=i:this.T(E.createTextNode(i)),this._$AH=i}$(i){let{values:t,_$litType$:e}=i,s=typeof e=="number"?this._$AC(i):(e.el===void 0&&(e.el=R.createElement(xt(e.h,e.h[0]),this.options)),e);if(this._$AH?._$AD===s)this._$AH.p(t);else{let a=new K(s,this),n=a.u(this.options);a.p(t),this.T(n),this._$AH=a}}_$AC(i){let t=yt.get(i.strings);return t===void 0&&yt.set(i.strings,t=new R(i)),t}k(i){tt(this._$AH)||(this._$AH=[],this._$AR());let t=this._$AH,e,s=0;for(let a of i)s===t.length?t.push(e=new o(this.O(O()),this.O(O()),this,this.options)):e=t[s],e._$AI(a),s++;s<t.length&&(this._$AR(e&&e._$AB.nextSibling,s),t.length=s)}_$AR(i=this._$AA.nextSibling,t){for(this._$AP?.(!1,!0,t);i!==this._$AB;){let e=pt(i).nextSibling;pt(i).remove(),i=e}}setConnected(i){this._$AM===void 0&&(this._$Cv=i,this._$AP?.(i))}},M=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(i,t,e,s,a){this.type=1,this._$AH=v,this._$AN=void 0,this.element=i,this.name=t,this._$AM=s,this.options=a,e.length>2||e[0]!==""||e[1]!==""?(this._$AH=Array(e.length-1).fill(new String),this.strings=e):this._$AH=v}_$AI(i,t=this,e,s){let a=this.strings,n=!1;if(a===void 0)i=k(this,i,t,0),n=!N(i)||i!==this._$AH&&i!==A,n&&(this._$AH=i);else{let r=i,c,u;for(i=a[0],c=0;c<a.length-1;c++)u=k(this,r[e+c],t,c),u===A&&(u=this._$AH[c]),n||=!N(u)||u!==this._$AH[c],u===v?i=v:i!==v&&(i+=(u??"")+a[c+1]),this._$AH[c]=u}n&&!s&&this.j(i)}j(i){i===v?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,i??"")}},Y=class extends M{constructor(){super(...arguments),this.type=3}j(i){this.element[this.name]=i===v?void 0:i}},X=class extends M{constructor(){super(...arguments),this.type=4}j(i){this.element.toggleAttribute(this.name,!!i&&i!==v)}},Z=class extends M{constructor(i,t,e,s,a){super(i,t,e,s,a),this.type=5}_$AI(i,t=this){if((i=k(this,i,t,0)??v)===A)return;let e=this._$AH,s=i===v&&e!==v||i.capture!==e.capture||i.once!==e.once||i.passive!==e.passive,a=i!==v&&(e===v||s);s&&this.element.removeEventListener(this.name,this,e),a&&this.element.addEventListener(this.name,this,i),this._$AH=i}handleEvent(i){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,i):this._$AH.handleEvent(i)}},G=class{constructor(i,t,e){this.element=i,this.type=6,this._$AN=void 0,this._$AM=t,this.options=e}get _$AU(){return this._$AM._$AU}_$AI(i){k(this,i)}};var qt=Q.litHtmlPolyfillSupport;qt?.(R,H),(Q.litHtmlVersions??=[]).push("3.3.3");var wt=(o,i,t)=>{let e=t?.renderBefore??i,s=e._$litPart$;if(s===void 0){let a=t?.renderBefore??null;e._$litPart$=s=new H(i.insertBefore(O(),a),a,void 0,t??{})}return s._$AI(o),s};var st=globalThis,x=class extends ${constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){let i=super.createRenderRoot();return this.renderOptions.renderBefore??=i.firstChild,i}update(i){let t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(i),this._$Do=wt(t,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return A}};x._$litElement$=!0,x.finalized=!0,st.litElementHydrateSupport?.({LitElement:x});var Vt=st.litElementPolyfillSupport;Vt?.({LitElement:x});(st.litElementVersions??=[]).push("4.2.2");var Bt={attribute:!0,type:String,converter:C,reflect:!1,hasChanged:P},Ut=(o=Bt,i,t)=>{let{kind:e,metadata:s}=t,a=globalThis.litPropertyMetadata.get(s);if(a===void 0&&globalThis.litPropertyMetadata.set(s,a=new Map),e==="setter"&&((o=Object.create(o)).wrapped=!0),a.set(t.name,o),e==="accessor"){let{name:n}=t;return{set(r){let c=i.get.call(this);i.set.call(this,r),this.requestUpdate(n,c,o,!0,r)},init(r){return r!==void 0&&this.C(n,void 0,o,r),r}}}if(e==="setter"){let{name:n}=t;return function(r){let c=this[n];i.call(this,r),this.requestUpdate(n,c,o,!0,r)}}throw Error("Unsupported decorator location: "+e)};function F(o){return(i,t)=>typeof t=="object"?Ut(o,i,t):((e,s,a)=>{let n=s.hasOwnProperty(a);return s.constructor.createProperty(a,e),n?Object.getOwnPropertyDescriptor(s,a):void 0})(o,i,t)}function h(o){return F({...o,state:!0,attribute:!1})}var it=560,Jt=JSON.stringify({id:"my_widget",label:"My Widget",w:16,h:7,default_cfg:{color:[0,255,0]},draw:[{op:"value",x:0,y:1,bind:"solar",fmt:"{:.1f}"},{op:"bar",x:0,y:6,w:16,h:1,bind:"soc",max:100,color:[0,120,255],bg:[30,30,30]}]},null,2),_t={galactic:[53,11],cosmic:[32,32],stellar:[16,16]},St="__mock__",Et=["value","bar","rect","pixel","icon","dot"],Kt={value:[["bind","text"],["fmt","text"],["color","rgb"]],bar:[["w","num"],["h","num"],["bind","text"],["max","num"],["color","rgb"],["bg","rgb"]],rect:[["w","num"],["h","num"],["color","rgb"]],pixel:[["color","rgb"]],icon:[["name","icon"]],dot:[["w","num"],["h","num"],["bind","text"],["on_color","rgb"],["off_color","rgb"]]},At=o=>{let[i,t,e]=o??[0,0,0];return"#"+[i,t,e].map(s=>Math.max(0,Math.min(255,s|0)).toString(16).padStart(2,"0")).join("")},kt=o=>{let i=(o||"").replace("#","");return[0,2,4].map(t=>parseInt(i.substr(t,2),16)||0)},d=class extends x{constructor(){super(...arguments);this.devices=[];this.entryId="";this.model="galactic";this.layout={widgets:[]};this.caps=[];this.overlayCaps=[];this.defaultLayout={widgets:[]};this.stored={};this.png="";this.wboxes=[];this.dims=[53,11];this.zoom=0;this.selected=-1;this.layoutName="default";this.live=!1;this.wireframe=!0;this.status="";this.tab="layout";this.catalog=[];this.fwManifest=null;this.contentLayouts=[];this.contentScreensets=[];this.showAllContent=!1;this.iconNames=[];this.installedIcons=[];this.iconCode="";this.iconName="";this.dirty=!1;this.sectionsOpen={};this.screenLayouts=[];this.screenDwell=10;this.screenTransition="none";this.screenPngs={};this.screenIdx=0;this.screenOpacity=1;this.screenTimer=0;this.specText=Jt;this.editMode="form";this.specPng="";this.specError="";this.specTimer=0;this._onKey=t=>{let e=t.target?.tagName;if(e==="INPUT"||e==="SELECT"||e==="TEXTAREA")return;let a={ArrowUp:[0,-1],ArrowDown:[0,1],ArrowLeft:[-1,0],ArrowRight:[1,0]}[t.key];a&&(t.preventDefault(),this._nudge(a[0],a[1]))}}static{this.styles=B`
    :host {
